...
class BetterPlayerController {
  ...
  ///Clear overridden aspect ratio and trigger UI refresh.
  void clearOverriddenAspectRatio() {
    _overriddenAspectRatio = null;
    _postControllerEvent(BetterPlayerControllerEvent.setFit);
  }

  ///Refresh the player UI by triggering a rebuild.
  void refresh() {
    _postControllerEvent(BetterPlayerControllerEvent.setFit);
  }
