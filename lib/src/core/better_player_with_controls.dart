...
class _BetterPlayerWithControlsState extends State<BetterPlayerWithControls> {
  ...
  Widget build(BuildContext context) {
    ...
    double? aspectRatio;
    final double? overriddenAspect = betterPlayerController.getAspectRatio();
    aspectRatio = overriddenAspect ?? betterPlayerController.videoPlayerController?.value.aspectRatio;
...
class _BetterPlayerVideoFitWidgetState extends State<_BetterPlayerVideoFitWidget> {
  ...
  Widget build(BuildContext context) {
    if (_initialized && _started) {
      final overriddenAspectRatio = widget.betterPlayerController.getAspectRatio();
      double width = controller!.value.size?.width ?? 1920;
      double height = controller!.value.size?.height ?? 1080;

      if (overriddenAspectRatio != null && overriddenAspectRatio > 0) {
        height = width / overriddenAspectRatio;
      }
